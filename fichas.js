...
const TREINOS = {
  A: [
    { id: "7057e1b0-2f42-4605-b3d8-1da02b04d24f", nome: "Puxada frontal aberta",             aparelho: "4",     equipamento: "cabo",     series: 3, reps: 12, cod: 541,  grupos: ["costas"] },
    ...
    { id: "76d614e3-a9e5-45dc-8530-5b53b07e9461", nome: "Remada baixa aberta",               aparelho: "4",     equipamento: "cabo",     series: 3, reps: 12, cod: 268,  grupos: ["costas"] },
  ...
  B: [
    ...
    { id: "684b4ef1-c6cc-4dc9-ab1f-d3a18b331335", nome: "Crucifixo inclinado",               aparelho: "16/25", equipamento: "halteres", series: 3, reps: 12, cod: 200,  grupos: ["peito"] },
    { id: "0901767e-9ced-47c3-9e60-f50f788cf82f", nome: "Desenvolvimento aberto na máquina", aparelho: "18",    equipamento: "maquina",  series: 3, reps: 12, cod: 579,  grupos: ["ombro", "triceps"] },
    ...
    { id: "4cd63d78-9a69-4ec0-a70b-4c64d4b0f32e", nome: "Tríceps testa na máquina",          aparelho: "50",    equipamento: "maquina",  series: 3, reps: 12, cod: 1242, grupos: ["triceps"] }
  ],
  C: [
    { id: "1866f756-f1dc-4814-8ad1-bd787bfde6c0", nome: "Extensão de pernas na máquina",     aparelho: "6",     equipamento: "maquina",  series: 3, reps: 12, cod: 63,   grupos: ["quadriceps"] },
    ...
    { id: "9f32f7a1-bf59-4e24-8d15-3f5488f0d8d8", nome: "Abdução na máquina",                aparelho: "37",    equipamento: "maquina",  series: 3, reps: 12, cod: 1104, grupos: ["gluteo"] },
    { id: "ae7d7ffa-4112-49f5-a9e3-20bd832061e0", nome: "Adução na máquina",                 aparelho: "21",    equipamento: "maquina",  series: 3, reps: 12, cod: 220,  grupos: ["adutor"] },
